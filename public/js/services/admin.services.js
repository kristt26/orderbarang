...
function orderServices($http, $q, helperServices, AuthService, pesan) {
    var controller = helperServices.url + 'order/';
    var service = {};
    service.data = [];
    return {
        get: get,
    ...
    function post(param) {
        ...
        $http({
            ...
            (res) => {
                service.data.pesanan.push(res.data);
                def.resolve(res.data);
            },
            (err) => {
                pesan.error(err.data.messages.error);
...
function pesananServices($http, $q, helperServices, AuthService, pesan) {
    var controller = helperServices.url + 'pesanan/';
    var service = {};
    service.data = [];
    return {
        get: get,
    ...
    function post(param) {
        ...
        $http({
            ...
            (res) => {
                var data = service.data.find(x => x.id == param.id);
                if (data) {
                    data.pengiriman = res.data.pengiriman;
