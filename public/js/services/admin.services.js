angular.module('admin.service', [])
    ...
    .factory('supplierServices', supplierServices)
...
function supplierServices($http, $q, helperServices, AuthService, pesan) {
    var controller = helperServices.url + 'supplier/';
    var service = {};
    service.data = [];
    return {
        get: get,
    ...
    function put(param) {
        ...
        $http({
            ...
            (res) => {
                var data = service.data.find(x => x.id == param.id);
                if (data) {
                    data.nama_supplier = param.nama_supplier;
...
function pegawaiServices($http, $q, helperServices, AuthService, pesan) {
...
function pembelianServices($http, $q, helperServices, AuthService, pesan) {
    ...
    function post(param) {
        ...
        $http({
            ...
            (res) => {
                service.data.pembelian.push(res.data);
                def.resolve(param);
            },
            (err) => {
                pesan.error(err.data.messages.error);
...
function orderServices($http, $q, helperServices, AuthService, pesan) {
    ...
    function bayar(param) {
        ...
        $http({
            method: 'post',
            url: controller + 'bayar',
            data: param,
            headers: AuthService.getHeader()
        }).then(
            (res) => {
                var data = service.data.pesanan.find(x => x.id == param.pesanan_id);
                if (data)
                    data.pembayaran = res.data;
                def.resolve(res.data);
            },
            (err) => {
                pesan.error(err.data.messages.error);
